          ...
          {isLoading ? (
            ...
            <>
              {propertyData === undefined ? (
                <>
                  <title>ZAHRA | Property Not Found</title>
                  <Box
                    sx={{
                      width: "100%",
                      minHeight: "80vh",
                ...
                <>
                  <title>{`ZAHRA | ${propertyData?.name}`}</title>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <Image
                                src="https://raw.githubusercontent.com/DATA-Container-100/hotel-cdn-imgs/main/uploads/avatar_02_svg.svg"
                                alt="avatar"
                                width={70}
                                height={70}
                              />
                          ...
                          <TextField
                            placeholder={`Hi Ahmed, I am interested in ${propertyData?.property_type}`}
                            multiline
                            rows={3}
